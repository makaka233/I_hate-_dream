...
def main() -> None:
    ...
    parser.add_argument("--agent-s-min-prob", type=float, default=0.38)
    ...
    for seed in eval_seeds:
        ...
        _, summary = evaluate(
            ...
            fast_checkpoint_path=args.fast_checkpoint if args.fast_policy in {"gnn_wms", "agent_s"} else None,
